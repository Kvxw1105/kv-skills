# biji-note-extractor 技能安装器 (Windows PowerShell)
$ErrorActionPreference = "Stop"

$Repo = "WalkGod-Lei/biji-note-extractor"
$Branch = "main"
$SkillName = "biji-note-extractor"
$BaseUrl = "https://raw.githubusercontent.com/$Repo/$Branch/main"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  biji-note-extractor 技能安装器" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
