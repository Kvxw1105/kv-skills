...
description: create stunning, animation-rich html presentations from scratch or by converting powerpoint files. use when the user wants to build a presentation, convert a ppt/pptx to web, create html slides for a talk or pitch, improve an existing html deck, or discover a strong visual direction through generated previews rather than abstract style choices.
---
...
- Generate 3 previews by default. If `bold-template-pack/selection-index.json` exists: use 1 safe preset from `STYLE_PRESETS.md`, at least 1 bold template, and 1 wildcard. If the bold template pack is absent: use 1 safe preset, 1 contrasting safe preset or self-generated custom direction, and 1 wildcard.
...
- For conservative or high-stakes decks, make the safe preset especially restrained; if the bold pack exists choose a calm, higher-formality bold template; otherwise use a restrained safe preset and an authoritative custom direction.
- For expressive decks, keep the safe preset as a readable fallback; if the bold pack exists choose one strong bold template; otherwise make the second and third previews adventurous, context-specific, and clearly different from the safe option.
